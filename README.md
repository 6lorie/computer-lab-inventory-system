...
- The tables are: users, equipment, borrow_records
...
DB_SERVER=DESKTOP-3LK8Q2C\GLORIE # Your server name

DB_NAME=ComputerLabInventorySystem # Database name

DB_TRUSTED=Yes # check the connection configuration for these three
